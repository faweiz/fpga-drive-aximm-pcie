...
# PCI Express reset (perst) - IOSTANDARD determined by VADJ (K39) -> H40
set_property PACKAGE_PIN BB24 [get_ports {perst_0[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {perst_0[0]}]

# PCI Express reference clock 100MHz
# IOSTANDARD for GT reference clock does not need to be specified (A10) -> E10 (A9) -> E9
