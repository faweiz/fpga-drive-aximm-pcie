...
HD_PWD='D:/Tony/Downloads/PCIe/fpga-drive-aximm-pcie/fmc--pcie/vc707/4_vc707_pcie_rc/Vivado/vc707_hpc1/vc707_hpc1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpgadrv_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpgadrv_wrapper.tcl -notrace
