...
HD_PWD='D:/Tony/Downloads/PCIe/12022023/tony/vc709_fmc_ep/Vivado/vc709_fmc_ep/vc709_fmc_ep.runs/vc709_fmc_ep_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vc709_fmc_ep.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vc709_fmc_ep.tcl
